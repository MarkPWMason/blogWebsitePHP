...
class UserController extends Controller
{
    public function register(Request $request)
    {
        ...
        auth()->login($user);
        return redirect('/')->with('success', 'Account Successfully Made!');
    }
    ...
    private function getSharedData($user)
    {
        ...
        View::share(
            'sharedData',
            ['currentlyFollowing' => $currentlyFollowing, 'avatar' => $user->avatar, 'username' => $user->username, 'postCount' => $user->posts()->count(), 'followerCount' => $user->followers()->count(), 'followingCount' => $user->following()->count()]
        );
    }
